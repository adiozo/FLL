"""Adapted Marugoto helpers used by the experiment pipeline."""
...
def train_categorical_model(
    ...
    *,
    ...
    info: Dict[str, Any] = {
        ...
        "clini": Path(clini_table).name,
        "slide": Path(slide_csv).name,
...
def _crossval_train(
    *, fold_path, fold_df, fold, info, target_label, target_enc, cat_labels, cont_labels, bag_size, batch_size, lr
):
